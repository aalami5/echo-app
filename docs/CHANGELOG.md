...
### Added
- **Native Live Voice** — Added OpenAI Realtime/WebRTC voice mode behind a new Live control on the chat screen, keeping the existing Whisper/ElevenLabs flow available for dictation-style interactions
